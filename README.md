...
- **[The Stall](https://github.com/thebrierfox/the-stall)** - 172 pay-per-call data tools via remote MCP: US stocks, ETF holdings, crypto sentiment, DeFi yields, options chains, Solana tx intel, sanctions screening (OFAC), macro indicators, congressional trades, insider filings, clinical trials, and more. No API keys — x402 USDC micropayments on Base. Remote endpoint: https://the-stall.intuitek.ai/mcp
